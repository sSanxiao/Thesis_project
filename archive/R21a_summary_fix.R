...
# ============================================================================
# ============================================================
# R21a SUMMARY fix - regenerate SUMMARY.txt from saved rds
# (R21a v4 ran successfully but failed at SUMMARY writing due
#  to a sprintf type mismatch; this script fixes that)
# ============================================================
...
# Reconstruct QC summary from metadata
...
qc_summary <- md[, .(
  ...
  median_percent_mito = round(median(percent_mito), 2)
), by = sample]
